...
x2=int(input('Ingrese la coordenada y del segundo punto en el plano cartesiano: '))
x3=int(input('Ingrese la coordenada X del segundo punto en el plano cartesiano: '))
x4=int(input('Ingrese la coordenada y del segundo punto en el plano cartesiano: '))
